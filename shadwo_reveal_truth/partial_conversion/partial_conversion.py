...
def analyze_color_conversion(light_image, dark_image, json_path, output_image_path):
    ...
    light_mode_low_range = [200, 200, 200] # rgb color value
    light_mode_high_range = [255, 255, 255] # rgb color value

    # range for the dark mode background color
    dark_mode_low_range = [0, 0, 0] # rgb color value
    dark_mode_high_range = [90, 90, 90] # rgb color value

    # Color the color range for the background
    ...
    # shweta November14 2024 - ticket-IPC2
...
def partial_conversion_inconsistency(light_image_path:str, dark_image_path:str, json_dir:str, output_image:str):
    # print('PARTIAL CONVERSION DETECTION')
