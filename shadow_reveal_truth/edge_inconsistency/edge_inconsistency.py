# edge inconsistency
'''
Edge inconsistency: chromaeye detect the discrepancies between light and dark edges (edges of button, divider, icon)
'''
...
def edge_difference(light_image, dark_image, edge_overlay_dir, missing_edge_dir):
    ...
    highlight_overlay[problematic_light > 0] = [0, 0, 255]  # Red for light-only edges #rgb color pixel value
